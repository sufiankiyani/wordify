                ...
                <div class="col-md-6">
                  ...
                  <a href="blog-single.html" class="blog-entry element-animate" data-animate-effect="fadeIn">
                    ...
                    <div class="blog-content-body">
                      <div class="post-meta">
                        <span class="author mr-2"><img src="<?php echo get_template_directory_uri(); ?>/images/person_1.jpg" alt="Colorlib"> <?php the_author(); ?></span>&bullet;
                        <span class="mr-2"><?php the_time('F jS, Y'); ?></span> &bullet;
                        <span class="ml-2"><span class="fa fa-comments"></span> 3</span>
                      </div>
                      <h2><?php  the_title();  ?></h2>
                    </div>
